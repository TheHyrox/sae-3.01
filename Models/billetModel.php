...
class billetModel
{
    ...
    public function getBillets(): false|array
    {
        $req = $this->db->prepare('SELECT * FROM BILLET');
        $req->execute();
        return $req->fetchAll(PDO::FETCH_ASSOC);
    }

    public function addBillet($name, $description, $date, $lieu, $cat, $nb_places, $prix, $img): void
    {
